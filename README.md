...
Keep that process running, open the bot in Telegram, and send `/start`. Stop it with `Ctrl+C`. The bot remains restricted to scientific profiles. This phase does not match jobs or schedule reminders yet.
